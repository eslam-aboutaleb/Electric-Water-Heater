...
;--------------------------------------------------------
	...
	global	_I2C_Master_RepeatedStart
...
;***
;entry:  _I2C_Master_Read	;Function start
; 2 exit points
;has an exit
;functions called:
;   _I2C_Master_Wait
...
;; ***	genFunction  2342 curr label offset=34previous max_key=1 
_I2C_Master_Read	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	1109 rIdx = r0x104F 
	.line	106; "TWI.c"	tWord I2C_Master_Read(tWord a)
	BANKSEL	r0x1000
	MOVWF	r0x1000
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2175:genCall
	.line	110; "TWI.c"	I2C_Master_Wait();
	CALL	_I2C_Master_Wait
...
;;	613
;;	aopForRemat 392
;;	418: rname _SSPCON2bits, val 0, const = 0
;; ***	genNearPointerSet  6521
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_SSPCON2bits
;; 	line = 6523 result AOP_PCODE=_SSPCON2bits, size=2, left -=-, size=0, right AOP_LIT=0x01, size=1
...
;; ***	saveRegisters  1803
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2175:genCall
	.line	114; "TWI.c"	I2C_Master_Wait();
	CALL	_I2C_Master_Wait
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1845:unsaveRegisters *{*
;; ***	unsaveRegisters  1847
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;; ***	genCast  7121
;; ***	aopForSym 315
;;	327 sym->rname = _SSPBUF, size = 1
;;	694 register type nRegs=2
;; 	line = 7129 result AOP_REG=r0x1050, size=2, left -=-, size=0, right AOP_DIR=_SSPBUF, size=1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7298:genCast
;;	1009
;;	1028  _SSPBUF   offset=0
	.line	116; "TWI.c"	temp = SSPBUF;
	BANKSEL	_SSPBUF
	MOVF	_SSPBUF,W
...
;; ***	saveRegisters  1803
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2175:genCall
	.line	118; "TWI.c"	I2C_Master_Wait();
	CALL	_I2C_Master_Wait
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1845:unsaveRegisters *{*
;; ***	unsaveRegisters  1847
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;; 	line = 1555 result AOP_REG=r0x1052, size=1, left AOP_REG=r0x104E, size=2, right -=-, size=0
;; ***	mov2w  1381  offset=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1386:mov2w
;;	1109 rIdx = r0x104E 
	.line	120; "TWI.c"	ACKDT = (a)?0:1;
	BANKSEL	r0x1001
	MOVF	r0x1001,W
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1580:genNot
;;	1109 rIdx = r0x104F 
	IORWF	r0x1000,W
...
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_SSPCON2bits
;; 	line = 6523 result AOP_PCODE=_SSPCON2bits, size=2, left -=-, size=0, right AOP_REG=r0x104E, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6249:genPackBits *{*
;; ***	genPackBits  6250
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _I2C_Master_Read

;***
;  pBlock Stats: dbName = C
;***
;entry:  _I2C_Master_Write	;Function start
; 2 exit points
;has an exit
;functions called:
;   _I2C_Master_Wait
...
_I2C_Master_Write	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7358:genReceive *{*
;; ***	genReceive  7359
...
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1907:assignResultValue *{*
;; ***	assignResultValue  1909
;; 	line = 1911 result -=-, size=0, left AOP_DIR=_SSPBUF, size=1, right -=-, size=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1009
;;	1028  _SSPBUF   offset=0
	.line	90; "TWI.c"	tByte I2C_Master_Write(tByte data)
	BANKSEL	_SSPBUF
	MOVWF	_SSPBUF
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2086:genCall *{*
...
_00135_DS_
	.line	96; "TWI.c"	while(!SSPIF); /* Wait Until Completion*/
	BANKSEL	_PIR1bits
	BTFSS	_PIR1bits,3
...
;;	_PIR1bits
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6275:genPackBits
	.line	98; "TWI.c"	I2C_CLEAR_INTERRUPT();
	BCF	_PIR1bits,3
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6162:genPointerGet *{*
...
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2340:genFunction *{*
;; ***	genFunction  2342 curr label offset=26previous max_key=0 
_I2C_NACK	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6686:genPointerSet *{*
...
;;	_SSPCON2bits
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6275:genPackBits
	.line	84; "TWI.c"	ACKEN = 1; // Send NACK
	BANKSEL	_SSPCON2bits
	BSF	_SSPCON2bits,4
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
...
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2340:genFunction *{*
;; ***	genFunction  2342 curr label offset=22previous max_key=0 
...
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_SSPCON2bits
;; 	line = 6523 result AOP_PCODE=_SSPCON2bits, size=2, left -=-, size=0, right AOP_LIT=0x00, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6249:genPackBits *{*
;; ***	genPackBits  6250
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_SSPCON2bits
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6275:genPackBits
	.line	68; "TWI.c"	ACKDT = 0; // 0 -> ACK
	BANKSEL	_SSPCON2bits
	BCF	_SSPCON2bits,5
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2086:genCall *{*
...
;;	_SSPCON2bits
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6275:genPackBits
	.line	72; "TWI.c"	ACKEN = 1; // Send ACK
	BANKSEL	_SSPCON2bits
	BSF	_SSPCON2bits,4
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
...
;  pBlock Stats: dbName = C
;***
;entry:  _I2C_Master_Stop	;Function start
; 2 exit points
;has an exit
;functions called:
;   _I2C_Master_Wait
...
_I2C_Master_Stop	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2086:genCall *{*
;; ***	genCall  2088
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _I2C_Master_Stop
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*

;***
;  pBlock Stats: dbName = C
;***
;entry:  _I2C_Master_RepeatedStart	;Function start
; 2 exit points
;has an exit
;functions called:
;   _I2C_Master_Wait
...
_I2C_Master_RepeatedStart	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2086:genCall *{*
;; ***	genCall  2088
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _I2C_Master_RepeatedStart
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*

;***
;  pBlock Stats: dbName = C
;***
;entry:  _I2C_Master_Start	;Function start
; 2 exit points
;has an exit
;functions called:
;   _I2C_Master_Wait
...
_I2C_Master_Start	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2086:genCall *{*
;; ***	genCall  2088
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _I2C_Master_Start
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*

;***
;  pBlock Stats: dbName = C
;***
;entry:  _I2C_Master_Wait	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
_I2C_Master_Wait	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
;; ***	genLabel  2763
...
;; ***	genAnd  3920
;; ***	aopForSym 315
;;	327 sym->rname = _SSPSTAT, size = 1
;; 	line = 3955 result AOP_CRY=0x00, size=0, left AOP_DIR=_SSPSTAT, size=1, right AOP_LIT=0x04, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:3842:isLiteralBit *{*
;; ***	isLiteralBit  3843
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4039:genAnd
_00110_DS_
	.line	32; "TWI.c"	CHECK_I2C_BUSY_WAIT();
	BANKSEL	_SSPSTAT
	BTFSC	_SSPSTAT,2
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4040:genAnd
...
;; ***	genAnd  3920
;; ***	aopForSym 315
;;	327 sym->rname = _SSPCON2, size = 1
;; 	line = 3955 result AOP_CRY=0x00, size=0, left AOP_DIR=_SSPCON2, size=1, right AOP_LIT=0x1f, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:3842:isLiteralBit *{*
;; ***	isLiteralBit  3843
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:3842:isLiteralBit *{*
;; ***	isLiteralBit  3843
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1386:mov2w
;;	1009
;;	1028  _SSPCON2   offset=0
	MOVF	_SSPCON2,W
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4066:genAnd
	ANDLW	0x1f
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4067:genAnd
	BTFSS	STATUS,2
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4070:genAnd
;; ***	popGetLabel  key=2, label offset 8
	GOTO	_00110_DS_
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:3888:jmpTrueOrFalse *{*
;; ***	jmpTrueOrFalse  3890
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _I2C_Master_Wait
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*

;***
;  pBlock Stats: dbName = C
;***
;entry:  _I2C_Master_Init	;Function start
; 2 exit points
;has an exit
;functions called:
;   __mullong
...
_I2C_Master_Init	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7358:genReceive *{*
;; ***	genReceive  7359
...
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1907:assignResultValue *{*
;; ***	assignResultValue  1909
;; 	line = 1911 result -=-, size=0, left AOP_REG=r0x1048, size=4, right -=-, size=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1109 rIdx = r0x104B 
	.line	13; "TWI.c"	void I2C_Master_Init(const tWord32 baud)
	BANKSEL	r0x1006
	MOVWF	r0x1006
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1423:get_returnvalue
;; ***	popRegFromIdx,1042  , rIdx=0x7f
...
;; ***	genAssign  6928
;; ***	aopForSym 315
;;	327 sym->rname = _SSPCON, size = 1
;; 	line = 6937 result AOP_DIR=_SSPCON, size=1, left -=-, size=0, right AOP_LIT=0x28, size=1
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7030:genAssign
	.line	17; "TWI.c"	SSPCON = 0x28;
	MOVLW	0x28
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7032:genAssign
;;	1009
;;	1028  _SSPCON   offset=0
	BANKSEL	_SSPCON
	MOVWF	_SSPCON
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6927:genAssign *{*
...
;; ***	aopForSym 315
;;	327 sym->rname = _SSPCON2, size = 1
;; 	line = 6937 result AOP_DIR=_SSPCON2, size=1, left -=-, size=0, right AOP_LIT=0x00, size=1
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1009
;;	1028  _SSPCON2   offset=0
	.line	18; "TWI.c"	SSPCON2 = 0;
	BANKSEL	_SSPCON2
	CLRF	_SSPCON2
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;; ***	aopForSym 315
;;	327 sym->rname = _SSPSTAT, size = 1
;; 	line = 6937 result AOP_DIR=_SSPSTAT, size=1, left -=-, size=0, right AOP_LIT=0x00, size=1
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1009
;;	1028  _SSPSTAT   offset=0
	.line	21; "TWI.c"	SSPSTAT = 0;
	CLRF	_SSPSTAT
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6686:genPointerSet *{*
...
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_TRISCbits
;; 	line = 6523 result AOP_PCODE=_TRISCbits, size=2, left -=-, size=0, right AOP_LIT=0x01, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6249:genPackBits *{*
;; ***	genPackBits  6250
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_TRISCbits
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6275:genPackBits
	.line	23; "TWI.c"	TRISC3 = 1;
	BSF	_TRISCbits,3
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6686:genPointerSet *{*
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _I2C_Master_Init
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*


;	code size estimation:
;	  125+   34 =   159 instructions (  386 byte)
