...
; global declarations
;--------------------------------------------------------
	global	_TempS_Update
	global	_TempS_CLRReadFlag
	global	_TempS_ReadDone
	global	_TempS_AvgReadings
	global	_TempS_GetTemp
	global	_TempS_Init
...
_TempValue	res	2
_Avg	res	2
_TempGlobalFlag	res	1
_TempS_Update_TempSense_Counter_1_51	res	2
_TempS_Update_index_1_51	res	2
;--------------------------------------------------------
; initialized data
;--------------------------------------------------------

ID_TempSensor_0	idata
_ReadingArr
	db	0x00, 0x00
	db	0x00, 0x00
	db	0x00, 0x00
...
; code
;--------------------------------------------------------
code_TempSensor	code
;***
;  pBlock Stats: dbName = C
;***
;entry:  _TempS_Update	;Function start
; 2 exit points
;has an exit
;functions called:
;   _ADC_Convert
...
;;	1028  _TempS_Update_TempSense_Counter_1_51   offset=0
	BANKSEL	_TempS_Update_TempSense_Counter_1_51
...
;;	1028  _TempS_Update_index_1_51   offset=0
	...
	BANKSEL	_TempS_Update_index_1_51
...
;  pBlock Stats: dbName = C
;***
;entry:  _TempS_CLRReadFlag	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;  pBlock Stats: dbName = C
;***
;entry:  _TempS_ReadDone	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;  pBlock Stats: dbName = C
;***
;entry:  _TempS_AvgReadings	;Function start
; 2 exit points
;has an exit
...
;  pBlock Stats: dbName = C
;***
;entry:  _TempS_GetTemp	;Function start
; 2 exit points
;has an exit
;1 compiler assigned register :
;   STK00
...
;  pBlock Stats: dbName = C
;***
;entry:  _TempS_Init	;Function start
; 2 exit points
;has an exit
;functions called:
;   _ADC_Init
...
;	  145+   41 =   186 instructions (  454 byte)
