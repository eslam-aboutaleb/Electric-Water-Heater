...
;;	694 register type nRegs=1
;; 	line = 3955 result AOP_REG=r0x1050, size=1, left AOP_DIR=_PORTB, size=1, right AOP_LIT=0x80, size=1
...
;;	694 register type nRegs=1
;;	694 register type nRegs=1
;; 	line = 3955 result AOP_REG=r0x104D, size=1, left AOP_REG=r0x104D, size=1, right AOP_LIT=0x7f, size=1
...
;; ***	aopForSym 315
;;	327 sym->rname = _TRISB, size = 1
;; 	line = 3955 result AOP_DIR=_TRISB, size=1, left AOP_REG=r0x104A, size=1, right AOP_LIT=0x7f, size=1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4190:genAnd
	MOVLW	0x7f
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4191:genAnd
;;	1109 rIdx = r0x104A 
...
;	   64+   24 =    88 instructions (  224 byte)
