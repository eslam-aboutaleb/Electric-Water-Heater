...
;--------------------------------------------------------
	global	_Cool_Update
	global	_Cool_GetState
	global	_Cool_SetState
	global	_Cool_Init
...
; code
;--------------------------------------------------------
code_Cooling_element	code
;***
;  pBlock Stats: dbName = C
;***
;entry:  _Cool_Update	;Function start
; 2 exit points
;has an exit
...
;; ***	genEndFunction  2530
	.line	68; "Cooling_element.c"	}
	RETURN	
; exit point of _Cool_Update

;***
;  pBlock Stats: dbName = C
;***
;entry:  _Cool_GetState	;Function start
; 2 exit points
;has an exit
...
;;	1109 rIdx = r0x104E 
	.line	49; "Cooling_element.c"	tCool_State Cool_GetState(tCool Fan)
	BANKSEL	r0x1000
	MOVWF	r0x1000
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	1109 rIdx = r0x104F 
	.line	51; "Cooling_element.c"	tCool_State ret = COOL_OFF;
	CLRF	r0x1001
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	1109 rIdx = r0x104E 
	.line	53; "Cooling_element.c"	switch(Fan)
	MOVF	r0x1000,W
;;1	MOVWF	r0x1002
	BTFSS	STATUS,2
...
;;	694 register type nRegs=1
;; 	line = 3955 result AOP_REG=r0x104E, size=1, left AOP_DIR=_PORTC, size=1, right AOP_LIT=0x04, size=1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4190:genAnd
	.line	56; "Cooling_element.c"	ret = GPIO_ReadPortPin(COOL_DATA_PORT,COOL_PIN);
	MOVLW	0x04
...
;;	1109 rIdx = r0x104F 
_00122_DS_
	.line	61; "Cooling_element.c"	return ret;
	BANKSEL	r0x1001
	MOVF	r0x1001,W
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1109 rIdx = r0x104B 
	.line	32; "Cooling_element.c"	void Cool_SetState(tCool Fan,tCool_State State)
	BANKSEL	r0x1003
	MOVWF	r0x1003
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7358:genReceive *{*
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7277:genCast
;;	1109 rIdx = r0x104B 
	.line	35; "Cooling_element.c"	switch(Fan)
	MOVF	r0x1003,W
	MOVWF	r0x1005
	BTFSS	STATUS,2
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:3678:genCmpEq
...
;;	1009
;;	1028  _PORTC   offset=0
	.line	38; "Cooling_element.c"	GPIO_WritePortPin(COOL_DATA_PORT,COOL_PIN,State);
	BANKSEL	_PORTC
	MOVF	_PORTC,W
...
;;	694 register type nRegs=1
;;	694 register type nRegs=1
;; 	line = 3955 result AOP_REG=r0x104B, size=1, left AOP_REG=r0x104B, size=1, right AOP_LIT=0xfb, size=1
...
;; ***	genEndFunction  2530
_00115_DS_
	.line	43; "Cooling_element.c"	}
	RETURN	
; exit point of _Cool_SetState
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*

;***
;  pBlock Stats: dbName = C
;***
;entry:  _Cool_Init	;Function start
; 2 exit points
;has an exit
;functions called:
;   _Cool_SetState
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1109 rIdx = r0x1048 
	.line	13; "Cooling_element.c"	void Cool_Init(tCool Fan,tCool_State State)
	BANKSEL	r0x1006
	MOVWF	r0x1006
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7358:genReceive *{*
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7277:genCast
;;	1109 rIdx = r0x1048 
	.line	16; "Cooling_element.c"	switch(Fan)
	MOVF	r0x1006,W
	MOVWF	r0x1008
	BTFSS	STATUS,2
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:3678:genCmpEq
...
;;	1028  _TRISC   offset=0
	.line	19; "Cooling_element.c"	GPIO_InitPortPin(COOL_CONTROL_PORT,COOL_PIN,GPIO_OUT);
	BANKSEL	_TRISC
	MOVF	_TRISC,W
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7278:genCast
;;	1109 rIdx = r0x104A 
...
;; ***	aopForSym 315
;;	327 sym->rname = _TRISC, size = 1
;; 	line = 3955 result AOP_DIR=_TRISC, size=1, left AOP_REG=r0x104A, size=1, right AOP_LIT=0xfb, size=1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4190:genAnd
	MOVLW	0xfb
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4191:genAnd
;;	1109 rIdx = r0x104A 
...
;;	1109 rIdx = r0x1049 
_00107_DS_
	.line	26; "Cooling_element.c"	Cool_SetState(Fan,State);
	BANKSEL	r0x1007
	MOVF	r0x1007,W
;;	694 register type nRegs=1
;; 	2135 left AOP_REG
