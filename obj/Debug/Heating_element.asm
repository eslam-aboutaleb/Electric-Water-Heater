...
;--------------------------------------------------------
	global	_Heat_Update
	global	_Heat_GetState
	global	_Heat_SetState
	global	_Heat_Init
...
; code
;--------------------------------------------------------
code_Heating_element	code
;***
;  pBlock Stats: dbName = C
;***
;entry:  _Heat_Update	;Function start
; 2 exit points
;has an exit
...
;; ***	genFunction  2342 curr label offset=19previous max_key=3 
_Heat_Update	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
;; ***	genLabel  2763
...
;; ***	genEndFunction  2530
	.line	63; "Heating_element.c"	}
	RETURN	
; exit point of _Heat_Update

;***
;  pBlock Stats: dbName = C
;***
;entry:  _Heat_GetState	;Function start
; 2 exit points
;has an exit
...
;;	1109 rIdx = r0x104E 
	.line	46; "Heating_element.c"	tHeat_State Heat_GetState(tHeat Heater)
	BANKSEL	r0x1000
	MOVWF	r0x1000
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	1109 rIdx = r0x104F 
	.line	48; "Heating_element.c"	tHeat_State ret = HEAT_OFF;
	CLRF	r0x1001
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	1109 rIdx = r0x104E 
	.line	49; "Heating_element.c"	switch(Heater)
	MOVF	r0x1000,W
;;1	MOVWF	r0x1002
	BTFSS	STATUS,2
...
;;	694 register type nRegs=1
;; 	line = 3955 result AOP_REG=r0x104E, size=1, left AOP_DIR=_PORTC, size=1, right AOP_LIT=0x20, size=1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4190:genAnd
	.line	52; "Heating_element.c"	ret = GPIO_ReadPortPin(HEAT_DATA_PORT,HEAT_PIN);
	MOVLW	0x20
...
;;	1109 rIdx = r0x104F 
_00122_DS_
	.line	57; "Heating_element.c"	return ret;
	BANKSEL	r0x1001
	MOVF	r0x1001,W
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1109 rIdx = r0x104B 
	.line	30; "Heating_element.c"	void Heat_SetState(tHeat Heater,tHeat_State State)
	BANKSEL	r0x1003
	MOVWF	r0x1003
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7358:genReceive *{*
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7277:genCast
;;	1109 rIdx = r0x104B 
	.line	32; "Heating_element.c"	switch(Heater)
	MOVF	r0x1003,W
	MOVWF	r0x1005
	BTFSS	STATUS,2
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:3678:genCmpEq
...
;;	327 sym->rname = _PORTC, size = 1
;;	694 register type nRegs=1
;; 	line = 7129 result AOP_REG=r0x104B, size=1, left -=-, size=0, right AOP_DIR=_PORTC, size=1
;; ***	genCast  7253
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7277:genCast
;;	1009
;;	1028  _PORTC   offset=0
	.line	35; "Heating_element.c"	GPIO_WritePortPin(HEAT_DATA_PORT,HEAT_PIN,State);
	BANKSEL	_PORTC
	MOVF	_PORTC,W
...
;;	694 register type nRegs=1
;;	694 register type nRegs=1
;; 	line = 3955 result AOP_REG=r0x104B, size=1, left AOP_REG=r0x104B, size=1, right AOP_LIT=0xdf, size=1
...
;; ***	genCast  7121
;;	694 register type nRegs=1
;; 	line = 7129 result AOP_REG=r0x104C, size=1, left -=-, size=0, right AOP_REG=r0x104D, size=1
;; ***	genCast  7253
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7277:genCast
;;	1109 rIdx = r0x104D 
	MOVF	r0x1005,W
...
;; ***	genEndFunction  2530
_00115_DS_
	.line	40; "Heating_element.c"	}
	RETURN	
; exit point of _Heat_SetState
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*

;***
;  pBlock Stats: dbName = C
;***
;entry:  _Heat_Init	;Function start
; 2 exit points
;has an exit
;functions called:
;   _Heat_SetState
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1393:movwf
;;	1109 rIdx = r0x1048 
	.line	13; "Heating_element.c"	void Heat_Init(tHeat Heater,tHeat_State State)
	BANKSEL	r0x1006
	MOVWF	r0x1006
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7358:genReceive *{*
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7277:genCast
;;	1109 rIdx = r0x1048 
	.line	15; "Heating_element.c"	switch(Heater)
	MOVF	r0x1006,W
	MOVWF	r0x1008
	BTFSS	STATUS,2
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:3678:genCmpEq
...
;;	694 register type nRegs=1
;; 	line = 7129 result AOP_REG=r0x104A, size=1, left -=-, size=0, right AOP_DIR=_TRISC, size=1
;; ***	genCast  7253
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7277:genCast
;;	1009
;;	1028  _TRISC   offset=0
	.line	18; "Heating_element.c"	GPIO_InitPortPin(HEAT_CONTROL_PORT,HEAT_PIN,GPIO_OUT);
	BANKSEL	_TRISC
	MOVF	_TRISC,W
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7278:genCast
;;	1109 rIdx = r0x104A 
...
;; ***	aopForSym 315
;;	327 sym->rname = _TRISC, size = 1
;; 	line = 3955 result AOP_DIR=_TRISC, size=1, left AOP_REG=r0x104A, size=1, right AOP_LIT=0xdf, size=1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4190:genAnd
	MOVLW	0xdf
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4191:genAnd
;;	1109 rIdx = r0x104A 
...
;;	1109 rIdx = r0x1049 
_00107_DS_
	.line	24; "Heating_element.c"	Heat_SetState(Heater,State);
	BANKSEL	r0x1007
	MOVF	r0x1007,W
;;	694 register type nRegs=1
;; 	2135 left AOP_REG
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _Heat_Init
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*


;	code size estimation:
;	   53+   15 =    68 instructions (  166 byte)
