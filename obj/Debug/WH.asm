...
_Current_Temp	res	1
_WH_State	res	1
_WH_Update_WH_counter_1_70	res	2
;--------------------------------------------------------
; initialized data
;--------------------------------------------------------
...
;***
;entry:  _WH_UsedTemp	;Function start
; 2 exit points
;has an exit
;functions called:
;   _WH_CheckFirstUse
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_CheckFirstUse	;Function start
; 2 exit points
;has an exit
;functions called:
;   _EEPROM_Read
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_TurnON_OFF	;Function start
; 2 exit points
;has an exit
;functions called:
;   _SW_GetState
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_CheckChange	;Function start
; 2 exit points
;has an exit
;functions called:
;   _WH_GetState
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_Cool_Heat	;Function start
; 2 exit points
;has an exit
;functions called:
;   _TempS_ReadDone
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_FetchLastTemp	;Function start
; 2 exit points
;has an exit
;functions called:
;   _EEPROM_Read
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_SaveLastTemp	;Function start
; 2 exit points
;has an exit
;functions called:
;   _EEPROM_Write
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_Set_Temp	;Function start
; 2 exit points
;has an exit
;3 compiler assigned registers:
;   r0x1008
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_Update	;Function start
; 2 exit points
;has an exit
;functions called:
;   _WH_SaveLastTemp
...
;;	1028  _WH_Update_WH_counter_1_70   offset=0
	BANKSEL	_WH_Update_WH_counter_1_70
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_GetState	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;  pBlock Stats: dbName = C
;***
;entry:  _WH_GetTemp	;Function start
; 2 exit points
;has an exit
;3 compiler assigned registers:
;   r0x1014
...
;	  308+   93 =   401 instructions (  988 byte)
